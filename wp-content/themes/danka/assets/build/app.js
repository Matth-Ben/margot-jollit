...
/* harmony import */ var _components_welcome__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/welcome */ "./assets/scripts/components/welcome.js");
/* harmony import */ var _components_welcome__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_welcome__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_some_discoveries__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/some-discoveries */ "./assets/scripts/components/some-discoveries.js");
/* harmony import */ var _components_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/slider */ "./assets/scripts/components/slider.js");
...
/* harmony import */ var _components_marquee_logos__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/marquee-logos */ "./assets/scripts/components/marquee-logos.js");
/* harmony import */ var _components_pannel_navigation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/pannel-navigation */ "./assets/scripts/components/pannel-navigation.js");
/* harmony import */ var _components_pannel_navigation__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_pannel_navigation__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_pannel_filters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/pannel-filters */ "./assets/scripts/components/pannel-filters.js");
...
var init_custom_checkbox = function init_custom_checkbox() {
  document.querySelectorAll('input[type="checkbox"]:not(.custom)').forEach(function (checkbox) {
...
//// custom select
var init_custom_select = function init_custom_select() {
  document.querySelectorAll('select:not(.custom)').forEach(function (select) {
...
var trapFocus = function trapFocus(element, escape_function) {
  ////
  ...
  if (focusableElements.length === 0) {
    ...
    var handleFocusTrap = function handleFocusTrap(event) {
      if (event.key === 'Tab') {
        if (event.shiftKey) {
...
////
var init_pannel = function init_pannel() {
  // create overlay
  ...
  document.querySelectorAll('.component-pannel').forEach(function (element) {
    var _element$querySelecto, _data;
    if (element.classList.contains('component-pannel--init')) {
      return;
    } else {
      element.classList.add('component-pannel--init');
    }
    var pannel_id = element.getAttribute('id');
    if (!pannel_id) return;
    var openButton;
    ...
    var from_parameters = {};
    var parameters = {
      duration: (_data = data) !== null && _data !== void 0 && (_data = _data.transitions) !== null && _data !== void 0 && (_data = _data.secondary) !== null && _data !== void 0 && _data.duration ? data.transitions.secondary.duration / 1000 : 1.4,
      ease: 'power2.inOut',
      onComplete: function onComplete() {},
      onReverseComplete: function onReverseComplete() {}
    };
    var open = function open(toggleButton) {
      timeline.play();
    ...
    document.addEventListener('click', function (event) {
      ...
      id = (_button = button) === null || _button === void 0 ? void 0 : _button.getAttribute('data-pannel-target');
      if (id !== pannel_id) {
        return;
      }
      toggleButtons = document.querySelectorAll("[data-pannel-target=\"".concat(pannel_id, "\"]"));
    ...
    document.addEventListener('ClosePannel', function () {
      if (element.classList.contains('active')) {
        close();
        toggleButtons.forEach(function (button) {
          return button.classList.remove('active');
...
var Marquee = /*#__PURE__*/_createClass(function Marquee(element) {
  ...
  var speed = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.4;
  ...
  _defineProperty(this, "run", function () {
    ...
    if (!_this.element.classList.contains('paused')) {
      _this.index = _this.index + _this.speed;
    }
    requestAnimationFrame(_this.run);
  });
  _defineProperty(this, "run_reverse", function () {
    _this.firstElement.style.marginLeft = "-".concat(_this.index, "px");
    if (_this.index < 0) {
      _this.index = _this.firstElement.clientWidth;
    }
    if (!_this.element.classList.contains('paused')) {
      _this.index = _this.index - _this.speed;
    }
    requestAnimationFrame(_this.run_reverse);
  });
  var container = element.querySelector('.component__container');
  ...
  Array.from(container.children).forEach(function (child) {
    return totalWidth += child.clientWidth;
  });
  var index = 0; // prevent infinite loop
...
/***/ "./assets/scripts/components/accordions.js":
/*!*************************************************!*\
  !*** ./assets/scripts/components/accordions.js ***!
  \*************************************************/
/***/ (() => {
...
document.addEventListener('click', function (event) {
  var header = event.target.classList.contains('.accordion__header') ? event.target : null;
  header = header === null && event.target.closest('.accordion__header') ? event.target.closest('.accordion__header') : null;
  if (header) {
    var component = event.target.closest('.component--accordions');
    var current_accordion = event.target.closest('.accordion');
    var is_open = current_accordion && current_accordion.classList.contains('active') ? true : false;
    if (component && component.classList.contains('one-by-one')) {
      component.querySelectorAll('.accordion').forEach(function (item) {
...
/***/ "./assets/scripts/components/marquee-logos.js":
/*!****************************************************!*\
  !*** ./assets/scripts/components/marquee-logos.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var init = function init() {
  document.querySelectorAll('.component--marquee-logos').forEach(function (marquee) {
    var button_pause = marquee.querySelector('button');
    new _class_class_marquee__WEBPACK_IMPORTED_MODULE_0__["default"](marquee, false, 0.8);
    if (button_pause) {
...
/***/ "./assets/scripts/components/pannel-filters.js":
/*!*****************************************************!*\
  !*** ./assets/scripts/components/pannel-filters.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {

var _require = __webpack_require__(/*! ../core/taxi */ "./assets/scripts/core/taxi.js"),
  taxi = _require["default"];
var init = function init() {
  document.querySelectorAll('.component-pannel-filters').forEach(function (element) {
    var navigation_buttons = element.querySelectorAll('.component-pannel-filters__navigation button');
    var reset_button = element.querySelector('.component-pannel-filters__reset-button');
    var apply_button = element.querySelector('.component-pannel-filters__apply-button');
    var pannels_taxonomy = element.querySelectorAll('.component-pannel-filters__filter-taxonomy'); // Panneaux des taxonomies
    var date_buttons = element.querySelectorAll('.component-pannel-filters__filter-dates button'); // Panneau des dates

    var current_open_button = null;
    ...
    if (navigation_buttons.length > 0) {
      navigation_buttons.forEach(function (button) {
        button.addEventListener('click', function () {
          ...
          navigation_buttons.forEach(function (b) {
            return b.classList.remove('active');
          }); // Réinitialisation des boutons
          button.classList.add('active'); // Activation du bouton
          element.querySelectorAll('.component-pannel-filters__content > div').forEach(function (pannel) {
            return pannel.classList.remove('active');
    ...
    // Taxonomies
    pannels_taxonomy.forEach(function (pannel) {
      var buttons = pannel.querySelectorAll('button');
    ...
    // Dates
    date_buttons.forEach(function (button) {
      button.addEventListener('click', function () {
    ...
    reset_button.addEventListener('click', function () {
      ...
      }, (_data = data) !== null && _data !== void 0 && (_data = _data.transitions) !== null && _data !== void 0 && (_data = _data.secondary) !== null && _data !== void 0 && _data.duration ? data.transitions.secondary.duration : 1400);
    });

    // Application
    apply_button.addEventListener('click', function () {
      var _data2;
      var period_active = element.querySelector('[data-period].active');
      var museum_active = element.querySelector('.component__pannel-museums button.active');
      var url = new URL(window.location.href);
      var search_params = url.searchParams;

      // Ajouter les données des taxonomies dans l'URL
      var taxonomies_parameter = [];
      pannels_taxonomy.forEach(function (pannel) {
        var active = pannel.querySelector('button.active:not([data-term="all"])');
        if (active) {
      ...
      }, (_data2 = data) !== null && _data2 !== void 0 && (_data2 = _data2.transitions) !== null && _data2 !== void 0 && (_data2 = _data2.secondary) !== null && _data2 !== void 0 && _data2.duration ? data.transitions.secondary.duration : 1400);
    });
...
/***/ "./assets/scripts/components/pannel-navigation.js":
/*!********************************************************!*\
  !*** ./assets/scripts/components/pannel-navigation.js ***!
  \********************************************************/
/***/ (() => {
...
var init = function init() {
  document.querySelectorAll('.component-slider').forEach(function (element) {
    var items = element.querySelectorAll('.component-slider__item');
    var previous_button = element.querySelector('.component-slider__previous');
    var next_button = element.querySelector('.component-slider__next');
    var current = 0;
...
/***/ "./assets/scripts/components/some-discoveries.js":
/*!*******************************************************!*\
  !*** ./assets/scripts/components/some-discoveries.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var init = function init() {
  document.querySelectorAll(".component-some-events").forEach(function (element) {
    var carousel = element.querySelector(".swiper");
    var previous = element.querySelector(".component-some-events__previous");
    var next = element.querySelector(".component-some-events__next");
    var list_name = element.getAttribute('data-post-type') ? element.getAttribute('data-post-type') : 'secondary';
    ...
    if (carousel) {
      ...
      var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]("#".concat(id), {
        autoHeight: true,
        grabCursor: true,
...
document.addEventListener('Welcome', function () {
  var loading_elements = document.querySelectorAll('[data-loading]');
  document.dispatchEvent(new CustomEvent('PreContentLoaded'));
  if (loading_elements) {
    var i = setInterval(function () {
      var is_ready = true;
      loading_elements.forEach(function (element) {
...
/***/ "./assets/scripts/core/fix-scroll-behavior.js":
/*!****************************************************!*\
  !*** ./assets/scripts/core/fix-scroll-behavior.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  ...
  var scroll_to_anchor = function scroll_to_anchor() {
    var _link;
    var href = (_link = link) === null || _link === void 0 ? void 0 : _link.getAttribute('href');
    var anchor = href === null || href === void 0 ? void 0 : href.split('#')[1];
    if (!anchor) return;
  ...
  document.addEventListener('click', function (event) {
    ...
    var href = (_link2 = link) === null || _link2 === void 0 ? void 0 : _link2.getAttribute('href');
    var anchor = href === '#' ? href : href === null || href === void 0 ? void 0 : href.split('#')[1];
    if (!anchor) return;
    if (anchor === '#') {
      lenis.scrollTo(0);
    } else {
  ...
  document.addEventListener('NewContentLoaded', function () {
    ...
    var anchor = url === null || url === void 0 ? void 0 : url.split('#')[1];
    if (!anchor) return;
    var target = document.getElementById(anchor);
    if (target) {
      lenis.scrollTo(target, {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  headroom.init();
  var headroom_element = document.querySelector('.component--headroom');
  if (headroom_element) {
    var show_duration = headroom_element.getAttribute('show-duration');
    if (show_duration) {
      setTimeout(function () {
...
/* harmony import */ var _fix_scroll_behavior__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./fix-scroll-behavior */ "./assets/scripts/core/fix-scroll-behavior.js");
/* harmony import */ var _quick_links__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./quick-links */ "./assets/scripts/core/quick-links.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((function () {
  ...
  document.addEventListener('ContentLoaded', function () {
    ...
    (0,_fix_scroll_behavior__WEBPACK_IMPORTED_MODULE_12__["default"])();
    (0,_quick_links__WEBPACK_IMPORTED_MODULE_13__["default"])();
  ...
  _createClass(Parallax, [{
    ...
    value: function observe() {
      document.querySelectorAll('[parallax]').forEach(function (element) {
        ...
        var value = scrollPosition * speed;
        if (element.getAttribute('parallax-down') !== null) {
          value = window.scrollY * speed;
        }
...
/***/ "./assets/scripts/core/quick-links.js":
/*!********************************************!*\
  !*** ./assets/scripts/core/quick-links.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  if (!document.body.classList.contains('show-elements-init')) {
    document.addEventListener('ElementsInView', function (event) {
...
var CustomTransition = /*#__PURE__*/function (_Transition) {
  ...
  function CustomTransition() {
    ...
    return _callSuper(this, CustomTransition, arguments);
  }
...
var TimelineAnimation = /*#__PURE__*/_createClass(function TimelineAnimation() {
  ...
  _defineProperty(this, "get_delay", function (element) {
    var delay = element.getAttribute('show-delay'),
      ...
      text_delay = element.getAttribute('show-after-text');
    ...
    if (text_delay) {
      var el = document.getElementById(text_delay);
      if (el) {
        var words = el.querySelectorAll('.word');
        text_delay = words.length * 70 + 10;
      }
    }
    return Number.isInteger(delay + text_delay) ? delay + text_delay : 0;
  });
  _defineProperty(this, "show_element", function (element, delay) {
    setTimeout(function () {
      element.classList.add('is-in-view');
      document.dispatchEvent(new CustomEvent('ElementsInView', {
        detail: {
          elements: [element]
        }
      }));
  ...
  document.addEventListener('ShowElements', function (event) {
    var elements = event.detail.elements;
    _this.show_elements(elements[0], 0);
  });
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"breakpoints":{"s":0,"m":768,"l":1024,"xl":1280,"xxl":1440},"gutters":{"s":1.6,"m":2.4},"margins":{"s":2,"m":2.4,"xl":4.8},"breakpointDesktop":"l","rem":{"s":"10px","xxl":"scale"},"colors":{"dark":"#000","light":"#fff","primary":"#304ACF","blue":"#A6B4FF","orange":"#FF8A70","yellow":"#F5D276","pink":"#F8A9E2","green":"#B3DE98","valid":"#90E5A9","error":"#FC7B7D"},"fonts":{"default":{"name":"Inter","serif":"sans-serif"},"heading":{"name":"PP Mori","serif":"sans-serif"}},"textStyles":{"h1":{"font-size":"5.2rem","line-height":"5.6rem"},"h2":{"font-size":"3.6rem","line-height":"4rem"},"h3":{"font-size":"2.8rem","line-height":"3.2rem"},"h4":{"font-size":"2.4rem","line-height":"3rem"},"titles":{"font-family":"heading"},"body":{"font-size":"1.6rem","line-height":"2.2rem","font-family":"default"},"body2":{"font-size":"1.4rem","line-height":"2.4rem"},"cta":{"font-size":"1.4rem","line-height":"1.8rem","font-weight":"600","font-family":"heading"},"bold":{"font-weight":"600"},"desktop":{"h1":{"font-size":"8rem","line-height":"8.4rem"},"h2":{"font-size":"4.8rem","line-height":"5.2rem"},"h3":{"font-size":"3.2rem","line-height":"3.6rem"}}},"spacings":{"s":0.4,"m":0.8,"l":1.6,"xl":2.4,"xxl":4.8,"xxxl":9.6,"xxxxl":12},"maxColumns":{"s":6,"m":8,"l":12},"radius":0,"lists":{"default":{"s":1,"m":4},"secondary":{"s":1,"m":3}},"transitions":{"default":{"duration":400,"timing":"ease"},"secondary":{"duration":800,"timing":"ease-in-out"}}}');
